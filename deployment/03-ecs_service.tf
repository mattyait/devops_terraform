...
module "ecs_alb_security_group" {
  count               = var.ecs_service_create ? 1 : 0
...
module "ecs_alb_loadbalancer" {
  ...
  security_groups       = [module.ecs_alb_security_group[0].security_group_id_out]
...
module "app_ecs_service" {
  ...
  name                          = var.ecs_name
  environment                   = var.environment
  ecs_cluster_arn               = module.app_ecs_cluster[0].ecs_cluster_arn_out
  ...
  associate_alb                 = true
  alb_security_group            = module.ecs_alb_security_group[0].security_group_id_out
  lb_target_group               = module.ecs_alb_loadbalancer[0].alb_target_group_id_out
  ...
  cluster_name                = module.app_ecs_cluster[0].ecs_cluster_name_out
